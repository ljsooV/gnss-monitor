...
```powershell
binary/build/x64-Debug/gnss-monitor.exe file samples/sample.nmea binary/test-logs
binary/build/x64-Debug/gnss-monitor.exe file samples/no_fix.nmea binary/test-logs
```
...
4. 사용 위성 수, HDOP, 위도·경도, 고도가 출력되는지 확인한다.
